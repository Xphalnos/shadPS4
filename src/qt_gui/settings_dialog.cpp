...
SettingsDialog::SettingsDialog(std::span<const QString> physical_devices, QWidget* parent)
    ...
    // GENERAL TAB
    {
        ...
        connect(ui->fullscreenCheckBox, &QCheckBox::checkStateChanged(Qt::CheckState), this,
                [](int val) { Config::setFullscreenMode(val); });

        connect(ui->showSplashCheckBox, &QCheckBox::checkStateChanged(Qt::CheckState), this,
                [](int val) { Config::setShowSplash(val); });

        connect(ui->ps4proCheckBox, &QCheckBox::checkStateChanged(Qt::CheckState), this,
        ...
        connect(ui->updateCheckBox, &QCheckBox::checkStateChanged(Qt::CheckState), this,
        ...
        connect(ui->playBGMCheckBox, &QCheckBox::checkStateChanged(Qt::CheckState), this, [](int val) {
        ...
        connect(ui->discordRPCCheckbox, &QCheckBox::checkStateChanged(Qt::CheckState), this, [](int val) {
    ...
    // GPU TAB
    {
        ...
        connect(ui->dumpShadersCheckBox, &QCheckBox::checkStateChanged(Qt::CheckState), this,
                [](int val) { Config::setDumpShaders(val); });

        connect(ui->nullGpuCheckBox, &QCheckBox::checkStateChanged(Qt::CheckState), this,
                [](int val) { Config::setNullGpu(val); });
    }

    // DEBUG TAB
    {
        connect(ui->debugDump, &QCheckBox::checkStateChanged(Qt::CheckState), this,
                [](int val) { Config::setDebugDump(val); });

        connect(ui->vkValidationCheckBox, &QCheckBox::checkStateChanged(Qt::CheckState), this,
                [](int val) { Config::setVkValidation(val); });

        connect(ui->vkSyncValidationCheckBox, &QCheckBox::checkStateChanged(Qt::CheckState), this,
                [](int val) { Config::setVkSyncValidation(val); });

        connect(ui->rdocCheckBox, &QCheckBox::checkStateChanged(Qt::CheckState), this,
